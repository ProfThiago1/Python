...
from manim.utils.color import YELLOW,YELLOW_D,YELLOW_A, BLUE, RED, RED_A, RED_D, color_gradient
import numpy as np
...
class Charge(VGroup):
    def __init__(
        ...
        **kwargs,
        ...
        self.point = point
        self.radius = (abs(magnitude) * 0.8 if abs(magnitude) < 2 else 0.8) * 0.3
        ...
        if magnitude > 0:
            ...
            color = YELLOW
            layer_colors = [YELLOW_D,YELLOW_A]
            layer_radius = 4
